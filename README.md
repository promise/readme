...
a `18.1813`-year old Node developer cruising through life with a terrible music taste, horrendous posture and probably in front of some sort of computer screen
...
✨ Pushed 1 commit to project-blurple/bot-icon-sync
✨ Pushed 1 commit to project-blurple/bot-icon-sync
✅ Merged PR #2 in project-blurple/bot-icon-sync
